...
class Dashboard extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['total_pembelian'] = $this->pembelian->getTotalPembelian(date('Y-m'));
        $data['total_untung'] = $this->transaksi->getTotalUntung(date('Y-m'));
        ...
        // foreach ($bln as $b) {
        //     $date = date('Y-') . $b;
        //     $total = (int) $this->pembelian->chartPembelian($date);
        //     $data['tr'][] = $total == null ? 0 : $total;
        // }
    ...
    //     foreach ($bln as $b) {
    //         $date = date('Y-') . $b;
    //         $total = (int) $this->transaksi->chartUntung($date);
    //         $data['tr'][] = $total == null ? 0 : $total;
    //     }
