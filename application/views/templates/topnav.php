<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark shadow-sm">
    ...
    <a class="navbar-brand order-lg-first text-sm-center font-weight-bold" href="<?= base_url(); ?>">TOKO PAK KHOLIK</a>
    <!-- Navbar-->
    <ul class="navbar-nav ml-auto mr-0 mr-md-3">
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle text-white" id="userDropdown" href="#" role="button"
                ...
                <img src="<?= base_url('assets/img/') . userdata()->foto; ?>" class="rounded-circle"
