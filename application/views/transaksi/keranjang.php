            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-sm text-right">
                        <a href="<?= base_url('transaksi/add_item') ?>" class="btn btn-primary"><i
                                class="fa fa-plus"></i> Tambah</a>
                        <a onclick="return confirm('Data pemesanan akan dihapus. anda yakin ingin batal?')"
                            href="<?= base_url('transaksi') ?>" class="btn btn-danger"><i class="fa fa-times"></i>
                            Batal</a>
                    </div>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a onclick="return confirm('Yakin ingin hapus?');"
                                        href="<?= base_url('transaksi/delete_item/' . $row->noItem) ?>"
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" readonly
                            value="<?= format_uang($total_harga, false); ?>">
                    </div>
                </div>
                <div class="form-group">
