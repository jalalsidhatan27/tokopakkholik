<div class="row">
    <div class="col-md-3">
        <ul class="list-group mb-3">
            ...
            <li class="list-group-item d-flex justify-content-between lh-condensed">
                <div>
                    <h6 class="my-0">untung</h6>
                    <small class="text-muted"><?= format_uang($transaksi->untung); ?></small>
                </div>
                <span class="text-muted"></span>
            </li>
            <li class="list-group-item d-flex justify-content-between lh-condensed">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm">
                        ...
                        <span class="text-muted small"><?= $transaksi->idTransaksi ?> &bullet;
                            <?= indo_date($transaksi->tanggal, true) ?></span>
                    </div>

                    <div class="col-sm text-right">
                        <a href="<?= base_url('transaksi/cetak_detail/') . $idTransaksi ?>" class="btn btn-primary"><i
                    ...
                    <table class="table table-hover mt-3 mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center"><?= format_uang($row->harga) ?></td>
                                <td align="center"><?= $row->qty; ?></td>
                                <td align="right"><?= format_uang($row->subtotal) ?></td>
                                <!-- <td align="right"><?= format_uang($row->untung) ?></td> -->
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                        <tfoot>
