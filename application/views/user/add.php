                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input readonly value="<?= set_value('idUser', $idUser); ?>" type="text" id="idUser"
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input autofocus onfocus="this.select()" value="<?= set_value('username'); ?>" type="text"
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input value="<?= set_value('konfpass'); ?>" type="password" id="konfpass" name="konfpass"
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input value="<?= set_value('nama'); ?>" type="text" id="nama" name="nama"
