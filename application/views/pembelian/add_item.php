            ...
            <div class="card-header bg-white">
                <div class="row">
                    ...
                    <div class="col text-right">
                        <a href="<?= base_url('pembelian/add') ?>" class="btn btn-sm btn-danger">
            ...
            <div class="card-body pb-2">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input value="<?= set_value('kdBarang') ?>" type="text" class="form-control" name="kdBarang"
                            id="kdBarang" placeholder="Kode Barang...">
                ...
                <div class="form-group">
                    ...
                    <input value="<?= set_value('qty'); ?>" placeholder="Jumlah Beli..." type="text"
                ...
                <table class="table" id="search-only-datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= $row->stok; ?></td>
                            <td>
                                <button data-stok="<?= $row->stok; ?>" data-kode="<?= $row->kdBarang; ?>" type="button"
                                    class="btn btn-pilih btn-sm btn-primary">
...
$(function() {
    $('body').on('click', '.modal-body .btn-pilih', function() {
        ...
        $('#qty').attr('placeholder', 'Tambahkan stok');
