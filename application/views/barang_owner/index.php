            ...
            <div class="card-header bg-white">
                <div class="row">
                    ...
                    <div class="col text-right">
                        <a href="<?= base_url('barang_owner/add') ?>" class="btn btn-sm btn-primary">
                ...
                <table class="table table-striped mb-0 datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" data-stok="<?= $row->stok; ?>"
                                    data-nama="<?= $row->namaBarang; ?>" data-kode="<?= $row->kdBarang; ?>"
                                    class="btn btn-sm btn-primary btn-tambahstok">
                                    <i class="fa fa-plus"></i>
                                </button>
                                <a href="<?= base_url('barang_owner/edit/') . $row->kdBarang ?>"
                                    class="btn btn-sm btn-warning">
                                    <i class="fa fa-edit"></i>
                                </a>
                                <a onclick="return confirm('Yakin ingin hapus data?')"
                                    href="<?= base_url('barang_owner/hapus/') . $row->kdBarang ?>"
...
<!-- Modal -->
<div class="modal fade" id="tambahStok" tabindex="-1" role="dialog" aria-labelledby="tambahStokTitle"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="number" autocomplete="off" min="1" name="stok" id="stok" class="form-control"
                        placeholder="Tambahan Stok...">
